# Virtual Mouse on Hand

A Simple Opencv app, which use Image-Processing for the basic
funtionality of Mouse (e.g. Moving of Pointer), with some Other funtions too.
